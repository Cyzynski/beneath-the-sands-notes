...
The Initiative of a controlled mount changes to match yours when you mount it. It moves on your turn as you direct it, and it has only three action options during that turn: [Dash](https://roll20.net/compendium/dnd5e/Rules:Rules%20Definitions?expansion=33335#Dash%20%5BAction%5D), [Disengage](https://roll20.net/compendium/dnd5e/Rules:Rules%20Definitions?expansion=33335#Disengage%20%5BAction%5D), and [Dodge](https://roll20.net/compendium/dnd5e/Rules:Rules%20Definitions?expansion=33335#Dodge%20%5BAction%5D). A controlled mount can move and act even on the turn that you mount it.
...
# Falling Off
If an effect is about to move your mount against its will while you’re on it, you must succeed on a DC 10 Dexterity saving throw or fall off, landing with the [Prone](https://roll20.net/compendium/dnd5e/Rules:Rules%20Definitions?expansion=33335#Prone%20%5BCondition%5D) condition in an unoccupied space within 5 feet of the mount.

While mounted, you must make the same save if you’re knocked [Prone](https://roll20.net/compendium/dnd5e/Rules:Rules%20Definitions?expansion=33335#Prone%20%5BCondition%5D) or the mount is.