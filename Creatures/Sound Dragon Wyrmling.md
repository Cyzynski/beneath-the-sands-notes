...
*(Adapted from @me.mimic)*
![[Sound_Dragon_Wyrmling.png|200]]
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STR | +3 | +5 | DEX | +0 | +0 | CON | +2 | +2 | 
| INT | +0 | +0 | WIS | +1 | +1 | CHA | +2 | +4 | 
...
***Aura of Silence.*** In the 5-foot emanation surrounding the dragon, no sound can be created within or pass through. Any creature or object entirely inside this emanation has immunity to thunder damage and has the deafened condition. Casting a spell with a Verbal component is impossible in this area. The dragon has full control over which sounds, creatures, or objects are affected by this aura.

## Actions
***Multiattack.*** The dragon makes two Rend attacks.

***Rend.*** *Melee Attack Roll*: +5, reach 5 ft. *Hit*: 7 (1d8 + 3) slashing damage plus 4 (1d6) thunder damage.
