...
**HP** 8 (2d6 + 1)
**Initiative** +3 (13)
**Speed** 0ft., fly 15 ft. (hover)

|  | MOD | SAVE |  | MOD | SAVE |  | MOD | SAVE |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| STR | -2 | -2 | DEX | +3 | +3 | CON | +1 | +1 | 
| INT | +1 | +1 | WIS | +0 | +0 | CHA | +0 | +0 | 

**Languages** understands Zmokan, but can't speak.
**CR** 1/8 (PB +2) #CR/eighth

## Traits
***Bloodied - Overheating.*** While at half its hit point maximum or lower, the drone's gun attacks deal an extra 3 (1d6) Fire damage
